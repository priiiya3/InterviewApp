...
public class ListAdapter extends RecyclerView.Adapter<ListAdapter.TaskViewHolder> {
    ...
    CreateEditBottomSheetFragment.setRefreshListener setRefreshListener;

    public ListAdapter(MainActivity context, List<Task> taskList, CreateEditBottomSheetFragment.setRefreshListener setRefreshListener) {
